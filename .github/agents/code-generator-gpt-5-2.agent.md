---
name: code-generator-gpt-5-2
description: 'Code generator agent using GPT 5.2 Codex for performance benchmarking and characteristic analysis.'
...
# CODE-GENERATOR AGENT (GPT 5.2 Codex Benchmark)

## Mission
Generate **production-ready code** from specifications with comprehensive tests, specifically configured to evaluate the capabilities of the **GPT 5.2 Codex** model.
...
Prompt: "Research best practices for [technology domain].
         ...
         Include case studies and rekomendations.
