...
TRPG적인 DICE 요소를 추가하여 단순히 치킨을 만들어 파는 타이쿤 게임 보다는
...
개별AI를 가진 고객은 구매여부를 결정할때, [가격] / [품질] / [인지도] / [욕구] 4가지의 요소를 고려하여 확률적으로 구매여부를 결정합니다.
 ...
 그리고 매턴 [욕구]% 의 확률로 구매 여부를 결정하고 결과가 True인 경우, [점유율]의 확률로 플레이어 혹은 AI경쟁자의 치킨을 구매한다.
[가격] / [품질] / [인지도] 의 합계는 [종합] 점수가 되고
모든 참여자(플레이어 및 AI 경쟁자들)의 종합점수를 합한 점수에서 각각의 비율만큼을 [점유율]로 각 참여자들에게 할당한다.
AI 고객은 그 [점유율]을 확률로 하여 어느 참여자에게서 구매할지를 결정하고 구매 결과를 처리한다.

[가격]
각 참여자의 동일한 분류의 제품 가격의 평균[시장평균가격]을 구하고,
각 참여자의 {[개별 제품 가격]/[시장평균가격]*100}을 개별제품의 [가격] 점수로 한다.
그리고 개별 참여자가 판매하고 있는 분류의 제품들의 [가격]점수의 평균을 그 참여자의 [가격]점수로 한다.

각 제품의 가격은 참여자가 정한 판매가격이다.

[품질]
각 참여자의 동일한 분류의 제품 품질의 평균[시장평균품질]을 구하고,
그리고 각 참여자의 {[개별 제품 품질]/[시장평균품질]*100}을 개별제품의 [품질] 점수로 한다.
그리고 개별 참여자가 판매하고 있는 분류의 제품들의 [품질]점수의 평균을 그 참여자의 [품질]점수로 한다.

각 제품의 품질은 참여자의 [요리]스탯과 레시피의 [연구도] 재료의 [품질]의 평균이다
...
각 제품의 인지도는 아래와 같이 결정된다
 ...
 - 매장의 {[점유율]*10} 만큼 각 제품의 인지도가 매일 증가한다.
