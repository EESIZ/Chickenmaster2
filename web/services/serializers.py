...
def serialize_player(player: Player) -> dict:
    ...
    return {
        ...
        "stats": {
            "cooking": {"level": stats.cooking.base_value, "exp": player.cooking.experience.value},
            "management": {"level": stats.management.base_value, "exp": player.management.experience.value},
            "service": {"level": stats.service.base_value, "exp": player.service.experience.value},
            "tech": {"level": stats.tech.base_value, "exp": player.tech.experience.value},
            "stamina": {"level": stats.stamina.base_value, "exp": player.stamina.experience.value},
        },
